...
export const MODULES = [
  ...
  },
  {
    ...
    lessons: [
      L('m3-l1', 'Anatomy of a Great Prompt', 'Role, context, task, format, examples — the five-part template.', 25, 'Beginner', 90),
      L('m3-l2', 'Zero-Shot, Few-Shot & In-Context Learning', 'Teaching a model with examples instead of training.', 30, 'Beginner', 90),
      L('m3-l3', 'Chain-of-Thought & Reasoning Techniques', 'Making models think step-by-step — and when reasoning models do it for you.', 35, 'Intermediate', 110),
      L('m3-l4', 'Controlling Format, Tone & Length', 'XML tags, markdown contracts, and output shaping tricks.', 25, 'Beginner', 90),
      L('m3-l5', 'Prompt Templates & Variables in Code', 'Treating prompts as versioned, testable software artifacts.', 30, 'Intermediate', 100),
      L('m3-l6', 'Prompt Injection & Defensive Prompting', 'The #1 LLM security hole — attack it yourself in a sandboxed simulator.', 40, 'Intermediate', 120),
      L('m3-l7', 'Evaluating & Iterating on Prompts', 'A/B your prompts with a scoring loop instead of vibes.', 35, 'Intermediate', 110),
      L('m3-l8', 'Checkpoint: The Prompt Gauntlet', 'Ten tasks, one model, your prompts — pass 8 to clear the module.', 30, 'Intermediate', 150),
    ],
  },
  {
